...
@LinkURI("https://w3id.org/linkml/Element")
public abstract class Element {
    ...
    @SlotName("id_prefixes")
    @LinkURI("https://w3id.org/linkml/id_prefixes")
    private List<String> idPrefixes;

    @SlotName("id_prefixes_are_closed")
    @LinkURI("https://w3id.org/linkml/id_prefixes_are_closed")
    private Boolean idPrefixesAreClosed;

    @SlotName("definition_uri")
    @Converter(CurieConverter.class)
    @LinkURI("https://w3id.org/linkml/definition_uri")
    private String definitionUri;

    @SlotName("local_names")
    @Inlined
    @LinkURI("https://w3id.org/linkml/local_names")
    private List<LocalName> localNames;

    @SlotName("conforms_to")
    @LinkURI("http://purl.org/dc/terms/conformsTo")
    private String conformsTo;

    @SlotName("implements")
    @Converter(CurieConverter.class)
    @LinkURI("https://w3id.org/linkml/implements")
    private List<String> implements_;

    @Converter(CurieConverter.class)
    @LinkURI("https://w3id.org/linkml/instantiates")
    ...
    public List<String> getIdPrefixes(boolean set) {
        if ( this.idPrefixes == null && set ) {
            this.idPrefixes = new ArrayList<>();
        }
        return this.idPrefixes;
    }

    public void setIdPrefixesAreClosed(Boolean idPrefixesAreClosed) {
        this.idPrefixesAreClosed = idPrefixesAreClosed;
    }

    public Boolean getIdPrefixesAreClosed() {
        return this.idPrefixesAreClosed;
    }
    ...
    public void setLocalNames(List<LocalName> localNames) {
        this.localNames = localNames;
    }

    public List<LocalName> getLocalNames() {
        return this.localNames;
    }

    public List<LocalName> getLocalNames(boolean set) {
        if ( this.localNames == null && set ) {
    ...
    public void setImplements(List<String> implements_) {
    ...
    public List<String> getImplements(boolean set) {
        if ( this.implements_ == null && set ) {
    ...
    public List<String> getInstantiates(boolean set) {
        if ( this.instantiates == null && set ) {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$idPrefixes = this.getIdPrefixes();
        final Object other$idPrefixes = other.getIdPrefixes();
        if ( this$idPrefixes == null ? other$idPrefixes != null : !this$idPrefixes.equals(other$idPrefixes)) return false;
        final Object this$idPrefixesAreClosed = this.getIdPrefixesAreClosed();
        final Object other$idPrefixesAreClosed = other.getIdPrefixesAreClosed();
        if ( this$idPrefixesAreClosed == null ? other$idPrefixesAreClosed != null : !this$idPrefixesAreClosed.equals(other$idPrefixesAreClosed)) return false;
        final Object this$definitionUri = this.getDefinitionUri();
        final Object other$definitionUri = other.getDefinitionUri();
        if ( this$definitionUri == null ? other$definitionUri != null : !this$definitionUri.equals(other$definitionUri)) return false;
        final Object this$localNames = this.getLocalNames();
        final Object other$localNames = other.getLocalNames();
        if ( this$localNames == null ? other$localNames != null : !this$localNames.equals(other$localNames)) return false;
        final Object this$conformsTo = this.getConformsTo();
        final Object other$conformsTo = other.getConformsTo();
        if ( this$conformsTo == null ? other$conformsTo != null : !this$conformsTo.equals(other$conformsTo)) return false;
        final Object this$implements_ = this.getImplements();
        final Object other$implements_ = other.getImplements();
        if ( this$implements_ == null ? other$implements_ != null : !this$implements_.equals(other$implements_)) return false;
        final Object this$instantiates = this.getInstantiates();
        final Object other$instantiates = other.getInstantiates();
        if ( this$instantiates == null ? other$instantiates != null : !this$instantiates.equals(other$instantiates)) return false;
    ...
    public int hashCode() {
        ...
        final Object $idPrefixes = this.getIdPrefixes();
        result = result * PRIME + ($idPrefixes == null ? 43 : $idPrefixes.hashCode());
        final Object $idPrefixesAreClosed = this.getIdPrefixesAreClosed();
        result = result * PRIME + ($idPrefixesAreClosed == null ? 43 : $idPrefixesAreClosed.hashCode());
        final Object $definitionUri = this.getDefinitionUri();
        result = result * PRIME + ($definitionUri == null ? 43 : $definitionUri.hashCode());
        final Object $localNames = this.getLocalNames();
        result = result * PRIME + ($localNames == null ? 43 : $localNames.hashCode());
        final Object $conformsTo = this.getConformsTo();
        result = result * PRIME + ($conformsTo == null ? 43 : $conformsTo.hashCode());
        final Object $implements_ = this.getImplements();
        result = result * PRIME + ($implements_ == null ? 43 : $implements_.hashCode());
        final Object $instantiates = this.getInstantiates();
        result = result * PRIME + ($instantiates == null ? 43 : $instantiates.hashCode());
