...
@LinkURI("https://w3id.org/linkml/PathExpression")
public class PathExpression {

    @SlotName("followed_by")
    @LinkURI("https://w3id.org/linkml/followed_by")
    private PathExpression followedBy;

    @SlotName("none_of")
    @LinkURI("https://w3id.org/linkml/none_of")
    private List<PathExpression> noneOf;

    @SlotName("any_of")
    @LinkURI("https://w3id.org/linkml/any_of")
    private List<PathExpression> anyOf;

    @SlotName("all_of")
    @LinkURI("https://w3id.org/linkml/all_of")
    private List<PathExpression> allOf;

    @SlotName("exactly_one_of")
    @LinkURI("https://w3id.org/linkml/exactly_one_of")
    private List<PathExpression> exactlyOneOf;

    @LinkURI("https://w3id.org/linkml/reversed")
    private Boolean reversed;

    @LinkURI("https://w3id.org/linkml/traverse")
    private SlotDefinition traverse;
    ...
    public void setFollowedBy(PathExpression followedBy) {
        this.followedBy = followedBy;
    }

    public PathExpression getFollowedBy() {
        return this.followedBy;
    }

    public void setNoneOf(List<PathExpression> noneOf) {
        this.noneOf = noneOf;
    }

    public List<PathExpression> getNoneOf() {
        return this.noneOf;
    }

    public List<PathExpression> getNoneOf(boolean set) {
    ...
    public void setAnyOf(List<PathExpression> anyOf) {
        this.anyOf = anyOf;
    }

    public List<PathExpression> getAnyOf() {
        return this.anyOf;
    }

    public List<PathExpression> getAnyOf(boolean set) {
    ...
    public void setAllOf(List<PathExpression> allOf) {
        this.allOf = allOf;
    }

    public List<PathExpression> getAllOf() {
        return this.allOf;
    }

    public List<PathExpression> getAllOf(boolean set) {
    ...
    public void setExactlyOneOf(List<PathExpression> exactlyOneOf) {
        this.exactlyOneOf = exactlyOneOf;
    }

    public List<PathExpression> getExactlyOneOf() {
        return this.exactlyOneOf;
    }

    public List<PathExpression> getExactlyOneOf(boolean set) {
    ...
    public void setTraverse(SlotDefinition traverse) {
        this.traverse = traverse;
    }

    public SlotDefinition getTraverse() {
    ...
    public String toString() {
        ...
        if ( (o = this.getReversed()) != null ) {
            sb.append("reversed=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getTraverse()) != null ) {
            sb.append("traverse=");
            sb.append(o);
            sb.append(",");
        }
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof PathExpression) ) return false;
        final PathExpression other = (PathExpression) o;
        if ( !other.canEqual((Object) this)) return false;
        final Object this$followedBy = this.getFollowedBy();
        final Object other$followedBy = other.getFollowedBy();
        if ( this$followedBy == null ? other$followedBy != null : !this$followedBy.equals(other$followedBy)) return false;
        ...
        final Object this$traverse = this.getTraverse();
        final Object other$traverse = other.getTraverse();
        if ( this$traverse == null ? other$traverse != null : !this$traverse.equals(other$traverse)) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PathExpression;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final Object $followedBy = this.getFollowedBy();
        result = result * PRIME + ($followedBy == null ? 43 : $followedBy.hashCode());
        ...
        final Object $traverse = this.getTraverse();
        result = result * PRIME + ($traverse == null ? 43 : $traverse.hashCode());
