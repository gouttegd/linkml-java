...
@LinkURI("https://w3id.org/linkml/ClassRule")
public class ClassRule extends ClassLevelRule {

    @Inlined
    @LinkURI("http://www.w3.org/ns/shacl#condition")
    private AnonymousClassExpression preconditions;

    @Inlined
    @LinkURI("https://w3id.org/linkml/postconditions")
    private AnonymousClassExpression postconditions;

    @Inlined
    @LinkURI("https://w3id.org/linkml/elseconditions")
    private AnonymousClassExpression elseconditions;

    @LinkURI("https://w3id.org/linkml/bidirectional")
    private Boolean bidirectional;

    @SlotName("open_world")
    @LinkURI("https://w3id.org/linkml/open_world")
    private Boolean openWorld;

    @LinkURI("http://www.w3.org/ns/shacl#order")
    private Integer rank;

    @LinkURI("http://www.w3.org/ns/shacl#deactivated")
    ...
    public void setPreconditions(AnonymousClassExpression preconditions) {
        this.preconditions = preconditions;
    }

    public AnonymousClassExpression getPreconditions() {
        return this.preconditions;
    }

    public void setPostconditions(AnonymousClassExpression postconditions) {
        this.postconditions = postconditions;
    }

    public AnonymousClassExpression getPostconditions() {
        return this.postconditions;
    }

    public void setElseconditions(AnonymousClassExpression elseconditions) {
        this.elseconditions = elseconditions;
    }

    public AnonymousClassExpression getElseconditions() {
        return this.elseconditions;
    }
    ...
    public String toString() {
        ...
        Object o;
        sb.append("ClassRule(");
        if ( (o = this.getPreconditions()) != null ) {
            sb.append("preconditions=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getPostconditions()) != null ) {
            sb.append("postconditions=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getElseconditions()) != null ) {
            sb.append("elseconditions=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getBidirectional()) != null ) {
            sb.append("bidirectional=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getOpenWorld()) != null ) {
            sb.append("open_world=");
            sb.append(o);
            sb.append(",");
        }
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof ClassRule) ) return false;
        final ClassRule other = (ClassRule) o;
        if ( !other.canEqual((Object) this)) return false;
        if ( !super.equals(o) ) return false;

        final Object this$preconditions = this.getPreconditions();
        final Object other$preconditions = other.getPreconditions();
        if ( this$preconditions == null ? other$preconditions != null : !this$preconditions.equals(other$preconditions)) return false;
        final Object this$postconditions = this.getPostconditions();
        final Object other$postconditions = other.getPostconditions();
        if ( this$postconditions == null ? other$postconditions != null : !this$postconditions.equals(other$postconditions)) return false;
        final Object this$elseconditions = this.getElseconditions();
        final Object other$elseconditions = other.getElseconditions();
        if ( this$elseconditions == null ? other$elseconditions != null : !this$elseconditions.equals(other$elseconditions)) return false;
        final Object this$bidirectional = this.getBidirectional();
        final Object other$bidirectional = other.getBidirectional();
        if ( this$bidirectional == null ? other$bidirectional != null : !this$bidirectional.equals(other$bidirectional)) return false;
        final Object this$openWorld = this.getOpenWorld();
        final Object other$openWorld = other.getOpenWorld();
        if ( this$openWorld == null ? other$openWorld != null : !this$openWorld.equals(other$openWorld)) return false;
        ...
        final Object this$deactivated = this.getDeactivated();
        final Object other$deactivated = other.getDeactivated();
        if ( this$deactivated == null ? other$deactivated != null : !this$deactivated.equals(other$deactivated)) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ClassRule;
    }
    ...
    public int hashCode() {
        ...
        final Object $preconditions = this.getPreconditions();
        result = result * PRIME + ($preconditions == null ? 43 : $preconditions.hashCode());
        final Object $postconditions = this.getPostconditions();
        result = result * PRIME + ($postconditions == null ? 43 : $postconditions.hashCode());
        final Object $elseconditions = this.getElseconditions();
        result = result * PRIME + ($elseconditions == null ? 43 : $elseconditions.hashCode());
        final Object $bidirectional = this.getBidirectional();
        result = result * PRIME + ($bidirectional == null ? 43 : $bidirectional.hashCode());
        final Object $openWorld = this.getOpenWorld();
        result = result * PRIME + ($openWorld == null ? 43 : $openWorld.hashCode());
        final Object $rank = this.getRank();
        result = result * PRIME + ($rank == null ? 43 : $rank.hashCode());
        final Object $deactivated = this.getDeactivated();
        result = result * PRIME + ($deactivated == null ? 43 : $deactivated.hashCode());
