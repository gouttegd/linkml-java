...
public class StructuredAlias {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("StructuredAlias(");
        if ( (o = this.getLiteralForm()) != null ) {
            sb.append("literal_form=");
            sb.append(o);
            sb.append(",");
        }
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof StructuredAlias) ) return false;
        final StructuredAlias other = (StructuredAlias) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof StructuredAlias;
    }
