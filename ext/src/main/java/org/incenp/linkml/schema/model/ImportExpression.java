...
@LinkURI("https://w3id.org/linkml/ImportExpression")
public class ImportExpression {

    @SlotName("import_from")
    @Required
    @Converter(CurieConverter.class)
    @LinkURI("https://w3id.org/linkml/import_from")
    private String importFrom;

    @SlotName("import_as")
    @LinkURI("https://w3id.org/linkml/import_as")
    private String importAs;

    @SlotName("import_map")
    @Inlined
    @LinkURI("https://w3id.org/linkml/import_map")
    private List<Setting> importMap;
    ...
    public void setImportMap(List<Setting> importMap) {
        this.importMap = importMap;
    }

    public List<Setting> getImportMap() {
        return this.importMap;
    }

    public List<Setting> getImportMap(boolean set) {
        if ( this.importMap == null && set ) {
            this.importMap = new ArrayList<>();
        }
        return this.importMap;
    }
    ...
    public String toString() {
        ...
        Object o;
        sb.append("ImportExpression(");
        if ( (o = this.getImportFrom()) != null ) {
            sb.append("import_from=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getImportAs()) != null ) {
            sb.append("import_as=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getImportMap()) != null ) {
            sb.append("import_map=");
            sb.append(o);
            sb.append(",");
        }
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof ImportExpression) ) return false;
        final ImportExpression other = (ImportExpression) o;
        if ( !other.canEqual((Object) this)) return false;
        final Object this$importFrom = this.getImportFrom();
        final Object other$importFrom = other.getImportFrom();
        if ( this$importFrom == null ? other$importFrom != null : !this$importFrom.equals(other$importFrom)) return false;
        final Object this$importAs = this.getImportAs();
        final Object other$importAs = other.getImportAs();
        if ( this$importAs == null ? other$importAs != null : !this$importAs.equals(other$importAs)) return false;
        final Object this$importMap = this.getImportMap();
        final Object other$importMap = other.getImportMap();
        if ( this$importMap == null ? other$importMap != null : !this$importMap.equals(other$importMap)) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ImportExpression;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final Object $importFrom = this.getImportFrom();
        result = result * PRIME + ($importFrom == null ? 43 : $importFrom.hashCode());
        final Object $importAs = this.getImportAs();
        result = result * PRIME + ($importAs == null ? 43 : $importAs.hashCode());
        final Object $importMap = this.getImportMap();
        result = result * PRIME + ($importMap == null ? 43 : $importMap.hashCode());
