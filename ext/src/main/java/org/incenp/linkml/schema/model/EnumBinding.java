...
@LinkURI("https://w3id.org/linkml/EnumBinding")
public class EnumBinding {

    @LinkURI("https://w3id.org/linkml/range")
    private EnumDefinition range;

    @SlotName("obligation_level")
    @LinkURI("https://w3id.org/linkml/obligation_level")
    private ObligationLevelEnum obligationLevel;

    @SlotName("binds_value_of")
    @LinkURI("https://w3id.org/linkml/binds_value_of")
    private String bindsValueOf;
    ...
    public void setRange(EnumDefinition range) {
        this.range = range;
    }

    public EnumDefinition getRange() {
        return this.range;
    }

    public void setObligationLevel(ObligationLevelEnum obligationLevel) {
        this.obligationLevel = obligationLevel;
    }

    public ObligationLevelEnum getObligationLevel() {
        return this.obligationLevel;
    }

    public void setBindsValueOf(String bindsValueOf) {
        this.bindsValueOf = bindsValueOf;
    }

    public String getBindsValueOf() {
        return this.bindsValueOf;
    }
    ...
    public String toString() {
        ...
        Object o;
        sb.append("EnumBinding(");
        if ( (o = this.getRange()) != null ) {
            sb.append("range=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getObligationLevel()) != null ) {
            sb.append("obligation_level=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getBindsValueOf()) != null ) {
            sb.append("binds_value_of=");
            sb.append(o);
            sb.append(",");
        }
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof EnumBinding) ) return false;
        final EnumBinding other = (EnumBinding) o;
        ...
        final Object this$obligationLevel = this.getObligationLevel();
        final Object other$obligationLevel = other.getObligationLevel();
        if ( this$obligationLevel == null ? other$obligationLevel != null : !this$obligationLevel.equals(other$obligationLevel)) return false;
        final Object this$bindsValueOf = this.getBindsValueOf();
        final Object other$bindsValueOf = other.getBindsValueOf();
        if ( this$bindsValueOf == null ? other$bindsValueOf != null : !this$bindsValueOf.equals(other$bindsValueOf)) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof EnumBinding;
    }
    ...
    public int hashCode() {
        ...
        final Object $obligationLevel = this.getObligationLevel();
        result = result * PRIME + ($obligationLevel == null ? 43 : $obligationLevel.hashCode());
        final Object $bindsValueOf = this.getBindsValueOf();
        result = result * PRIME + ($bindsValueOf == null ? 43 : $bindsValueOf.hashCode());
