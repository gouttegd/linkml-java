...
@LinkURI("https://w3id.org/linkml/PermissibleValue")
public class PermissibleValue {
    ...
    @LinkURI("https://w3id.org/linkml/meaning")
    ...
    private PermissibleValue isA;

    @LinkURI("https://w3id.org/linkml/mixins")
    private List<PermissibleValue> mixins;
    ...
    public void setIsA(PermissibleValue isA) {
        this.isA = isA;
    }

    public PermissibleValue getIsA() {
        return this.isA;
    }

    public void setMixins(List<PermissibleValue> mixins) {
        this.mixins = mixins;
    }

    public List<PermissibleValue> getMixins() {
        return this.mixins;
    }

    public List<PermissibleValue> getMixins(boolean set) {
    ...
    public String toString() {
        return "PermissibleValue(text=" + this.getText() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof PermissibleValue) ) return false;
        final PermissibleValue other = (PermissibleValue) o;
        ...
        final Object this$meaning = this.getMeaning();
        final Object other$meaning = other.getMeaning();
        if ( this$meaning == null ? other$meaning != null : !this$meaning.equals(other$meaning)) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PermissibleValue;
    }
    ...
    public int hashCode() {
        ...
        final Object $meaning = this.getMeaning();
        result = result * PRIME + ($meaning == null ? 43 : $meaning.hashCode());
