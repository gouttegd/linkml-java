...
@LinkURI("https://incenp.org/dvlpt/linkml-java/tests/samples#IdentifiedSelfDesignatedClass")
public class IdentifiedSelfDesignatedClass {
    ...
    public String toString() {
        return "IdentifiedSelfDesignatedClass(type=" + this.getType() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof IdentifiedSelfDesignatedClass) ) return false;
        final IdentifiedSelfDesignatedClass other = (IdentifiedSelfDesignatedClass) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof IdentifiedSelfDesignatedClass;
    }
