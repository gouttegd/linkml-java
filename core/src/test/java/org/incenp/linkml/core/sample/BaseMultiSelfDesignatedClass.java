...
@LinkURI("https://incenp.org/dvlpt/linkml-java/tests/samples#BaseMultiSelfDesignatedClass")
public class BaseMultiSelfDesignatedClass {
    ...
    public List<String> getType(boolean set) {
        if ( this.type == null && set ) {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("BaseMultiSelfDesignatedClass(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof BaseMultiSelfDesignatedClass) ) return false;
        final BaseMultiSelfDesignatedClass other = (BaseMultiSelfDesignatedClass) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BaseMultiSelfDesignatedClass;
    }
