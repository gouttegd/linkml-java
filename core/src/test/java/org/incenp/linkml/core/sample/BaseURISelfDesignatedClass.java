...
@LinkURI("https://incenp.org/dvlpt/linkml-java/tests/samples#BaseURISelfDesignatedClass")
public class BaseURISelfDesignatedClass {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("BaseURISelfDesignatedClass(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof BaseURISelfDesignatedClass) ) return false;
        final BaseURISelfDesignatedClass other = (BaseURISelfDesignatedClass) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BaseURISelfDesignatedClass;
    }
