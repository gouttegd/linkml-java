...
@LinkURI("https://incenp.org/dvlpt/linkml-java/tests/samples#URIKeyedSelfDesignatedClass")
public class URIKeyedSelfDesignatedClass {
    ...
    public String toString() {
        return "URIKeyedSelfDesignatedClass(type=" + this.getType() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof URIKeyedSelfDesignatedClass) ) return false;
        final URIKeyedSelfDesignatedClass other = (URIKeyedSelfDesignatedClass) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof URIKeyedSelfDesignatedClass;
    }
