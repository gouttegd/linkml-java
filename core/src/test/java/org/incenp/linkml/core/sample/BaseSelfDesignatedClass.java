...
@LinkURI("https://incenp.org/dvlpt/linkml-java/tests/samples#BaseSelfDesignatedClass")
public class BaseSelfDesignatedClass {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("BaseSelfDesignatedClass(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof BaseSelfDesignatedClass) ) return false;
        final BaseSelfDesignatedClass other = (BaseSelfDesignatedClass) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BaseSelfDesignatedClass;
    }
