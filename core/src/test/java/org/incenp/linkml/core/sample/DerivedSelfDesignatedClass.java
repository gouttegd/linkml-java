...
@LinkURI("https://incenp.org/dvlpt/linkml-java/tests/samples#DerivedSelfDesignatedClass")
public class DerivedSelfDesignatedClass extends BaseSelfDesignatedClass {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("DerivedSelfDesignatedClass(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof DerivedSelfDesignatedClass) ) return false;
        final DerivedSelfDesignatedClass other = (DerivedSelfDesignatedClass) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof DerivedSelfDesignatedClass;
    }
