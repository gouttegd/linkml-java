...
@LinkURI("https://w3id.org/linkml/ArrayExpression")
public class ArrayExpression {

    @SlotName("exact_number_dimensions")
    @LinkURI("https://w3id.org/linkml/exact_number_dimensions")
    private Integer exactNumberDimensions;

    @SlotName("minimum_number_dimensions")
    @LinkURI("https://w3id.org/linkml/minimum_number_dimensions")
    private Integer minimumNumberDimensions;

    @SlotName("maximum_number_dimensions")
    @LinkURI("https://w3id.org/linkml/maximum_number_dimensions")
    private Object maximumNumberDimensions;

    @LinkURI("https://w3id.org/linkml/dimensions")
    private List<DimensionExpression> dimensions;
    ...
    public void setExactNumberDimensions(Integer exactNumberDimensions) {
        this.exactNumberDimensions = exactNumberDimensions;
    }

    public Integer getExactNumberDimensions() {
        return this.exactNumberDimensions;
    }

    public void setMinimumNumberDimensions(Integer minimumNumberDimensions) {
        this.minimumNumberDimensions = minimumNumberDimensions;
    }

    public Integer getMinimumNumberDimensions() {
        return this.minimumNumberDimensions;
    }

    public void setMaximumNumberDimensions(Object maximumNumberDimensions) {
        this.maximumNumberDimensions = maximumNumberDimensions;
    }

    public Object getMaximumNumberDimensions() {
        return this.maximumNumberDimensions;
    }

    public void setDimensions(List<DimensionExpression> dimensions) {
    ...
    public List<DimensionExpression> getDimensions(boolean set) {
        if ( this.dimensions == null && set ) {
    ...
    public String toString() {
        ...
        if ( (o = this.getExactNumberDimensions()) != null ) {
            sb.append("exact_number_dimensions=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getMinimumNumberDimensions()) != null ) {
            sb.append("minimum_number_dimensions=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getMaximumNumberDimensions()) != null ) {
            sb.append("maximum_number_dimensions=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getDimensions()) != null ) {
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof ArrayExpression) ) return false;
        final ArrayExpression other = (ArrayExpression) o;
        if ( !other.canEqual((Object) this)) return false;
        final Object this$exactNumberDimensions = this.getExactNumberDimensions();
        final Object other$exactNumberDimensions = other.getExactNumberDimensions();
        if ( this$exactNumberDimensions == null ? other$exactNumberDimensions != null : !this$exactNumberDimensions.equals(other$exactNumberDimensions)) return false;
        final Object this$minimumNumberDimensions = this.getMinimumNumberDimensions();
        final Object other$minimumNumberDimensions = other.getMinimumNumberDimensions();
        if ( this$minimumNumberDimensions == null ? other$minimumNumberDimensions != null : !this$minimumNumberDimensions.equals(other$minimumNumberDimensions)) return false;
        final Object this$maximumNumberDimensions = this.getMaximumNumberDimensions();
        final Object other$maximumNumberDimensions = other.getMaximumNumberDimensions();
        if ( this$maximumNumberDimensions == null ? other$maximumNumberDimensions != null : !this$maximumNumberDimensions.equals(other$maximumNumberDimensions)) return false;
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final Object $exactNumberDimensions = this.getExactNumberDimensions();
        result = result * PRIME + ($exactNumberDimensions == null ? 43 : $exactNumberDimensions.hashCode());
        final Object $minimumNumberDimensions = this.getMinimumNumberDimensions();
        result = result * PRIME + ($minimumNumberDimensions == null ? 43 : $minimumNumberDimensions.hashCode());
        final Object $maximumNumberDimensions = this.getMaximumNumberDimensions();
        result = result * PRIME + ($maximumNumberDimensions == null ? 43 : $maximumNumberDimensions.hashCode());
