...
@LinkURI("https://w3id.org/linkml/EnumDefinition")
public class EnumDefinition extends Definition {

    @SlotName("enum_uri")
    @Converter(CurieConverter.class)
    @LinkURI("https://w3id.org/linkml/enum_uri")
    private String enumUri;
    ...
    public void setEnumUri(String enumUri) {
        this.enumUri = enumUri;
    }

    public String getEnumUri() {
        return this.enumUri;
    }
    ...
    public String toString() {
        return "EnumDefinition(name=" + this.getName() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof EnumDefinition) ) return false;
        final EnumDefinition other = (EnumDefinition) o;
        if ( !other.canEqual((Object) this)) return false;
        if ( !super.equals(o) ) return false;

        final Object this$enumUri = this.getEnumUri();
        final Object other$enumUri = other.getEnumUri();
        if ( this$enumUri == null ? other$enumUri != null : !this$enumUri.equals(other$enumUri)) return false;
    ...
    public int hashCode() {
        ...
        final Object $enumUri = this.getEnumUri();
        result = result * PRIME + ($enumUri == null ? 43 : $enumUri.hashCode());
