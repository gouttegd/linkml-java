...
@LinkURI("https://w3id.org/linkml/CommonMetadata")
public class CommonMetadata {
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof CommonMetadata) ) return false;
        final CommonMetadata other = (CommonMetadata) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof CommonMetadata;
    }
