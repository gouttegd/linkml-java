...
@LinkURI("https://w3id.org/linkml/DimensionExpression")
public class DimensionExpression {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("DimensionExpression(");
        if ( (o = this.getAlias()) != null ) {
            sb.append("alias=");
            sb.append(o);
            sb.append(",");
        }
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof DimensionExpression) ) return false;
        final DimensionExpression other = (DimensionExpression) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof DimensionExpression;
    }
