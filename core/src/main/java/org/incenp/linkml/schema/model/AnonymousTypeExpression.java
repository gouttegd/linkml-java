...
@LinkURI("https://w3id.org/linkml/AnonymousTypeExpression")
public class AnonymousTypeExpression {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("AnonymousTypeExpression(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof AnonymousTypeExpression) ) return false;
        final AnonymousTypeExpression other = (AnonymousTypeExpression) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AnonymousTypeExpression;
    }
