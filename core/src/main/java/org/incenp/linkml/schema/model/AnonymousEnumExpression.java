...
@LinkURI("https://w3id.org/linkml/AnonymousEnumExpression")
public class AnonymousEnumExpression {
    ...
    public String toString() {
        ...
        Object o;
        sb.append("AnonymousEnumExpression(");
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof AnonymousEnumExpression) ) return false;
        final AnonymousEnumExpression other = (AnonymousEnumExpression) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AnonymousEnumExpression;
    }
