...
@LinkURI("https://w3id.org/linkml/PatternExpression")
public class PatternExpression {

    @LinkURI("https://w3id.org/linkml/syntax")
    private String syntax;

    @LinkURI("https://w3id.org/linkml/interpolated")
    private Boolean interpolated;

    @SlotName("partial_match")
    @LinkURI("https://w3id.org/linkml/partial_match")
    ...
    public String toString() {
        ...
        if ( (o = this.getSyntax()) != null ) {
            sb.append("syntax=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getInterpolated()) != null ) {
            sb.append("interpolated=");
            sb.append(o);
            sb.append(",");
        }
        if ( (o = this.getPartialMatch()) != null ) {
            sb.append("partial_match=");
            sb.append(o);
            sb.append(",");
        }
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof PatternExpression) ) return false;
        final PatternExpression other = (PatternExpression) o;
        ...
        final Object this$interpolated = this.getInterpolated();
        final Object other$interpolated = other.getInterpolated();
        if ( this$interpolated == null ? other$interpolated != null : !this$interpolated.equals(other$interpolated)) return false;
        final Object this$partialMatch = this.getPartialMatch();
        final Object other$partialMatch = other.getPartialMatch();
        if ( this$partialMatch == null ? other$partialMatch != null : !this$partialMatch.equals(other$partialMatch)) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PatternExpression;
    }
    ...
    public int hashCode() {
        ...
        final Object $interpolated = this.getInterpolated();
        result = result * PRIME + ($interpolated == null ? 43 : $interpolated.hashCode());
        final Object $partialMatch = this.getPartialMatch();
        result = result * PRIME + ($partialMatch == null ? 43 : $partialMatch.hashCode());
